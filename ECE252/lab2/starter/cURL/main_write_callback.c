...
//The write callback function save a copy of the received data in RAM, the original received data from the curl get 
//request is at p_recv, we want to save it to user defined memory to perform some actions
size_t write_cb_curl3(char *p_recv, size_t size, size_t nmemb, void *p_userdata)
{
